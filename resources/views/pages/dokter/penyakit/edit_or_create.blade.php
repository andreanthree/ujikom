...
@section('breadcrumbs')
  <div class="breadcrumb-item"><a href="{{ route('penyakit.index') }}">Data {{$dataPage['title']}}</a></div>
...
@section('content')
  ...
  @component('components.form')
    ...
    @if(isset($item))
      ...
      @slot('method', 'PUT')
      @slot('form_action', 'penyakit.update')
      @slot('update_id', $item->kode_penyakit)
    @else 
      @slot('form_method', 'POST')
      @slot('form_action', 'penyakit.store')
    @endif
